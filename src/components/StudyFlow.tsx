...
export default function StudyFlow(props: Props) {
  ...
  return (
    <div class="study-flow">
      ...
      <section class="question-stage shell narrow" aria-labelledby="question-title">
      ...
      <Show when={finished()}>
        ...
        <section class="card-preview shell narrow" aria-labelledby="cards-title">
        ...
        <section class="notes-panel shell narrow" aria-labelledby="notes-title">
          <div>
        ...
        <footer class="unit-sources shell narrow">
